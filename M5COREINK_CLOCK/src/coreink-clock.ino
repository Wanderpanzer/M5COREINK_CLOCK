...
#define WIFI_RETRY_CONNECTION 9
...
const String key = "0000.json";  // 地域コードを記入 東京都の場合、130000.json
const String endpoint = "https://www.jma.go.jp/bosai/forecast/data/forecast/";
char *wd[7] = {"日","月","火","水","木","金","土"};
int gwt[] = {5,11,17}; // 天気予報を取得する時刻を記載する。 この場合は、5時と11時と17時
...
void darwDate( RTC_DateTypeDef *date)
{
    ...
    */   
    ...
    {printEfont(&TimePageSprite, c2 ,posX,0,2);posX += 16;}
    else
